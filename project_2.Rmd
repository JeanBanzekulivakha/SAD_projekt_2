...
Z tego powodu, nie wyróżniamy w tym przypadku istonie różniących się województw względem testu Chisq. Zgodnie z wykresem, w województwie mazowieckim zaszczepienie jest na poziomie 21%, a w województwie świętokrzyskim
...
```
Przy założeniu że poziom istotności jest ustalony jako 0.05 oraz przewadzonych testach (Chi-Sqyuare Test), odrzucamy hipotezę zerową i dochodzimy do wniosku, że w rzeczywistości,opierając się na danych lig piłkarskich, nie ma zależności pomiędzy wynikiem meczu, a krajem. Widać to po wynikach wartośći p-value = 0.3409 <= 0.05.
