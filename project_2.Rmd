...
count_vaccined_to_population <- function(population_data, vaccination_data) {
  ...
  for(i in data_column_names) {
    ...
    vaccination_data[[i]] <- as.numeric(as.character(vaccination_data[[i]])) / area_population
  }
...
ggplot(vaccination_data_total, aes(date)) +
  geom_line(aes(y = dolnoslaskie_calkowicie,wojewodztwo = "dolnoslaskie")) +
  geom_line(aes(y = kujawskopomorskie_calkowicie,wojewodztwo = "kujawsko-pomorskie")) +
  geom_line(aes(y = lubelskie_calkowicie,wojewodztwo = "lubelskie")) +
  geom_line(aes(y = lubuskie_calkowicie,wojewodztwo = "lubuskie")) +
  geom_line(aes(y = lodzkie_calkowicie,wojewodztwo = "lodzkie")) +
  geom_line(aes(y = malopolskie_calkowicie,wojewodztwo = "malopolskie")) +
  geom_line(aes(y = mazowieckie_calkowicie,wojewodztwo = "mazowieckie")) +
  geom_line(aes(y = opolskie_calkowicie,wojewodztwo = "opolskie")) +
  geom_line(aes(y = podkarpackie_calkowicie,wojewodztwo = "podkarpackie")) +
  geom_line(aes(y = podlaskie_calkowicie,wojewodztwo = "podlaskie")) +
  geom_line(aes(y = pomorskie_calkowicie,wojewodztwo = "pomorskie")) +
  geom_line(aes(y = slaskie_calkowicie,wojewodztwo = "slaskie")) +
  geom_line(aes(y = swietokrzyskie_calkowicie,wojewodztwo = "swietokrzyskie")) +
  geom_line(aes(y = warminskomazurskie_calkowicie,wojewodztwo = "warminsko-mazurskie")) +
  geom_line(aes(y = wielkopolskie_calkowicie,wojewodztwo = "wielkopolskie")) +
  geom_line(aes(y = zachodniopomorskie_calkowicie,wojewodztwo = "zachodniopomorskie")) +
  labs(
