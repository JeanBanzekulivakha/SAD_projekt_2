...
Dla każdej badanej próbki uzyskaliśmy jednakowe rezultaty swiadczące o odrzuceniu hipotezy zerowej. Potwierdza to także wykres powyżej, na którym nie
istaniją dwa województwa o wyraźnie zbliżonej wartosci przebiegu szczepień.
...
Na wykresie w zadaniu 1a niektóre z województw posidały bardziej zbliżony przebieg sczepień niż inne. Mimo to, wartość p dla każdej pary województw w teście Chisq była pomijalnie mała (bliska zeru), przez co odrzuciliśmy hipotezę zerową.
Z tego powodu, nie wyróżniamy w tym przypadku istonie różniących się województw względem testu Chisq. Różnice zaobserwowaliśmy na wykresie. W województwie mazowieckim zaszczepienie jest na poziomie 21%, a w województwie świętokrzyskim
...
* *Hipoteza alternatywna* - wynik meczy, rozumianego jako zwyciestwo, porazke lub remis gospodarzy, *ZALEŻY* od kraju rozgrywki.
